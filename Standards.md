...
All deliverables are to be tracked in your project repository - i.e. all code, all support scripts, all documentation, all test files.
...
Support tools will use a combination of C++, bash. Any C++ programs must also compile without errors or warnings with -Wall and -Wextra under g++.
